import { isNumber, numberFormat, unitConvert } from '@/utils';
import React, { CSSProperties } from 'react';

declare interface UnitType {
  data: number | string;
  show?: boolean; numberConversion?: boolean; useGrouping?: boolean;
  pointLength?: number;
  numStyle?: CSSProperties;
  unitStyle?: CSSProperties;
}

function Unit({ data, show, numberConversion, pointLength, useGrouping = false, numStyle, unitStyle }: UnitType) {
