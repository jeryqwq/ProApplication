...
function VisHeader({ formRef = undefined, tabs, initValue, value, tabBarExtraContent,
  children, onChange, formColumns, formProps = {},contentStyle, style,
  formRender }: VisHeaderProps) {
        ...
        <div className={`${prefix}-title`}>
          {
            ...
            size='small'
            items={tabs?.map(i => ({ label: i.title, children: undefined, ...i }))}
            // {...tabProps}
          />
          }
        </div>
